<template>
  <div id="app">
    ...
    <UpdateUser :showBack="showBack" @updateUser="updateUser" />
    <!--3.上传文件-->
    ...
    <Pagination :totalPageNum="totalPageNum" @pageNumChange="pageNumChange" />
  </div>
</template>
...
import myUtils from "../src/assets/js/utils/myUtils.js";
export default {
  name: "App",
  components: {
    InsertUser,
