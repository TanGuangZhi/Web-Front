 ...
 * @LastEditTime: 2022-01-20 18:55:59 Thu
...
let dbCinemaDistrictTable = require("../data/cinemaDistrict.js");
    ...
    static async update(cinema) {
        return await dbCinemaTable.updateMany({ _id: parseInt(cinema._id) }, {
            $set:
            {
                ...
                cinemaImg: cinema.cinemaImg,
                cinemaSalary: cinema.cinemaSalary,
                cinemaTime: cinema.cinemaTime
            }
        });
    }
